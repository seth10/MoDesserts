...
public final class EnumArt extends Enum
{
    ...
    private EnumArt(String p_i213_1_, int p_i213_2_, String p_i213_3_, int p_i213_4_, int p_i213_5_, int p_i213_6_, int p_i213_7_)
    {
        super(p_i213_1_, p_i213_2_);
        field_857_y = p_i213_3_;
        field_856_z = p_i213_4_;
        field_869_A = p_i213_5_;
        field_867_B = p_i213_6_;
        field_865_C = p_i213_7_;
    }
