...
public class WorldGenDeadBush extends WorldGenerator
{
    ...
    public WorldGenDeadBush(int p_i253_1_)
    {
        field_28055_a = p_i253_1_;
    }
    ...
    public boolean func_419_a(World p_419_1_, Random p_419_2_, int p_419_3_, int p_419_4_, int p_419_5_)
    {
        ...
        for(int j = 0; j < 4; j++)
        {
            ...
            if(p_419_1_.func_20111_e(k, l, i1) && ((BlockFlower)Block.field_542_n[field_28055_a]).func_220_f(p_419_1_, k, l, i1))
            {
                p_419_1_.func_462_a(k, l, i1, field_28055_a);
            }
        }
