...
public class WorldGenForest extends WorldGenerator
{
    ...
    public WorldGenForest(boolean p_i283_1_)
    {
        super(p_i283_1_);
    }
    ...
    public boolean func_419_a(World p_419_1_, Random p_419_2_, int p_419_3_, int p_419_4_, int p_419_5_)
    {
        ...
        for(int j = p_419_4_; j <= p_419_4_ + 1 + i; j++)
        {
            ...
            for(int j1 = p_419_3_ - byte0; j1 <= p_419_3_ + byte0 && flag; j1++)
            {
                for(int i2 = p_419_5_ - byte0; i2 <= p_419_5_ + byte0 && flag; i2++)
                {
                    if(j >= 0 && j < 256)
                    {
                        int k2 = p_419_1_.func_444_a(j1, j, i2);
                        if(k2 != 0 && k2 != Block.field_581_L.field_573_bc)
                        {
                            flag = false;
                        }
                    } else
        ...
        for(int l = (p_419_4_ - 3) + i; l <= p_419_4_ + i; l++)
        {
            int k1 = l - (p_419_4_ + i);
            int j2 = 1 - k1 / 2;
            for(int l2 = p_419_3_ - j2; l2 <= p_419_3_ + j2; l2++)
            {
                int i3 = l2 - p_419_3_;
                for(int j3 = p_419_5_ - j2; j3 <= p_419_5_ + j2; j3++)
                {
                    int k3 = j3 - p_419_5_;
                    if((Math.abs(i3) != j2 || Math.abs(k3) != j2 || p_419_2_.nextInt(2) != 0 && k1 != 0) && !Block.field_540_p[p_419_1_.func_444_a(l2, l, j3)])
                    {
                        func_41043_a(p_419_1_, l2, l, j3, Block.field_581_L.field_573_bc, 2);
                    }
                }
        ...
        {
            int l1 = p_419_1_.func_444_a(p_419_3_, p_419_4_ + i1, p_419_5_);
            if(l1 == 0 || l1 == Block.field_581_L.field_573_bc)
            {
                func_41043_a(p_419_1_, p_419_3_, p_419_4_ + i1, p_419_5_, Block.field_582_K.field_573_bc, 2);
            }
        }
