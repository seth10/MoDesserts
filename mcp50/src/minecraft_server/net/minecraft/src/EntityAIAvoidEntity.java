...
public class EntityAIAvoidEntity extends EntityAIBase
{
    ...
    public boolean shouldExecute()
    {
        ...
        Vec3D vec3d = RandomPositionGenerator.func_48394_b(theEntity, 16, 7, Vec3D.createVector(closestLivingEntity.posX, closestLivingEntity.posY, closestLivingEntity.posZ));
        ...
        return field_48231_f.isDestinationSame(vec3d);
    }
