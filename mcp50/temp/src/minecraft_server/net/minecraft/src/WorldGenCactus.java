...
public class WorldGenCactus extends WorldGenerator
{
    ...
    public boolean func_419_a(World p_419_1_, Random p_419_2_, int p_419_3_, int p_419_4_, int p_419_5_)
    {
        for(int i = 0; i < 10; i++)
        {
            ...
            if(!p_419_1_.func_20111_e(j, k, l))
            {
                continue;
            }
            int i1 = 1 + p_419_2_.nextInt(p_419_2_.nextInt(3) + 1);
            for(int j1 = 0; j1 < i1; j1++)
            {
                if(Block.field_622_aW.func_220_f(p_419_1_, j, k + j1, l))
                {
                    p_419_1_.func_462_a(j, k + j1, l, Block.field_622_aW.field_573_bc);
                }
            }
