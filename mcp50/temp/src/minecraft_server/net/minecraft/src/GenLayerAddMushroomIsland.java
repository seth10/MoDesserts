...
public class GenLayerAddMushroomIsland extends GenLayer
{
    ...
    public GenLayerAddMushroomIsland(long p_i248_1_, GenLayer p_i248_3_)
    {
        super(p_i248_1_);
        field_35023_a = p_i248_3_;
    }
    ...
    public int[] func_35018_a(int p_35018_1_, int p_35018_2_, int p_35018_3_, int p_35018_4_)
    {
        ...
        for(int i1 = 0; i1 < p_35018_4_; i1++)
        {
            for(int j1 = 0; j1 < p_35018_3_; j1++)
            {
                ...
                if(k2 == 0 && k1 == 0 && l1 == 0 && i2 == 0 && j2 == 0 && func_35016_a(100) == 0)
                {
                    ai1[j1 + i1 * p_35018_3_] = BiomeGenBase.field_40467_p.field_35529_y;
                } else
                {
