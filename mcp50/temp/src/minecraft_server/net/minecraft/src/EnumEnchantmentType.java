...
public final class EnumEnchantmentType extends Enum
{
    ...
    private EnumEnchantmentType(String p_i387_1_, int p_i387_2_)
    {
        super(p_i387_1_, p_i387_2_);
    }

    public boolean func_40525_a(Item p_40525_1_)
    {
        if(this == all)
        {
            return true;
        }
        if(p_40525_1_ instanceof ItemArmor)
        {
            if(this == armor)
            {
                return true;
            }
            ItemArmor itemarmor = (ItemArmor)p_40525_1_;
            if(itemarmor.field_257_aX == 0)
            {
                return this == armor_head;
            }
            if(itemarmor.field_257_aX == 2)
            {
                return this == armor_legs;
            }
            if(itemarmor.field_257_aX == 1)
            {
                return this == armor_torso;
            }
            if(itemarmor.field_257_aX == 3)
            {
        ...
        if(p_40525_1_ instanceof ItemSword)
        {
            return this == weapon;
        }
        if(p_40525_1_ instanceof ItemTool)
        {
            return this == digger;
        }
        if(p_40525_1_ instanceof ItemBow)
        {
            return this == bow;
        } else
        {
