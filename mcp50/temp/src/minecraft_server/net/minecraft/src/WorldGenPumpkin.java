...
public class WorldGenPumpkin extends WorldGenerator
{
    ...
    public boolean func_419_a(World p_419_1_, Random p_419_2_, int p_419_3_, int p_419_4_, int p_419_5_)
    {
        for(int i = 0; i < 64; i++)
        {
            ...
            if(p_419_1_.func_20111_e(j, k, l) && p_419_1_.func_444_a(j, k - 1, l) == Block.field_534_v.field_573_bc && Block.field_4052_bb.func_259_a(p_419_1_, j, k, l))
            {
                p_419_1_.func_470_a(j, k, l, Block.field_4052_bb.field_573_bc, p_419_2_.nextInt(4));
            }
        }
