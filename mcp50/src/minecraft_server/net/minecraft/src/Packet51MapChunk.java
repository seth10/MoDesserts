...
public class Packet51MapChunk extends Packet
{
    ...
    public Packet51MapChunk(Chunk par1Chunk, boolean par2, int par3)
    {
        ...
        {
            if (aextendedblockstorage[k] == null || par2 && aextendedblockstorage[k].isEmpty() || (par3 & 1 << k) == 0)
            {
                continue;
            }
        ...
        {
            if (aextendedblockstorage[j1] != null && (!par2 || !aextendedblockstorage[j1].isEmpty()) && (par3 & 1 << j1) != 0)
            {
        ...
        {
            if (aextendedblockstorage[k1] != null && (!par2 || !aextendedblockstorage[k1].isEmpty()) && (par3 & 1 << k1) != 0)
            {
        ...
        {
            if (aextendedblockstorage[l1] != null && (!par2 || !aextendedblockstorage[l1].isEmpty()) && (par3 & 1 << l1) != 0)
            {
        ...
        {
            if (aextendedblockstorage[i2] != null && (!par2 || !aextendedblockstorage[i2].isEmpty()) && (par3 & 1 << i2) != 0)
            {
        ...
        if (j > 0)
        {
            ...
            {
                if (aextendedblockstorage[j2] != null && (!par2 || !aextendedblockstorage[j2].isEmpty()) && aextendedblockstorage[j2].getBlockMSBArray() != null && (par3 & 1 << j2) != 0)
                {
