...
public class GenLayerVoronoiZoom extends GenLayer
{
    ...
    public GenLayerVoronoiZoom(long p_i247_1_, GenLayer p_i247_3_)
    {
        super(p_i247_1_);
        super.field_35023_a = p_i247_3_;
    }
    ...
    public int[] func_35018_a(int p_35018_1_, int p_35018_2_, int p_35018_3_, int p_35018_4_)
    {
        ...
        byte byte0 = 2;
        int i = 1 << byte0;
        int j = p_35018_1_ >> byte0;
        int k = p_35018_2_ >> byte0;
        int l = (p_35018_3_ >> byte0) + 3;
        int i1 = (p_35018_4_ >> byte0) + 3;
        int ai[] = field_35023_a.func_35018_a(j, k, l, i1);
        int j1 = l << byte0;
        int k1 = i1 << byte0;
        int ai1[] = IntCache.func_35549_a(j1 * k1);
        for(int l1 = 0; l1 < i1 - 1; l1++)
        {
            ...
            for(int l2 = 0; l2 < l - 1; l2++)
            {
                ...
                func_35017_a(l2 + j << byte0, l1 + k << byte0);
                double d1 = ((double)func_35016_a(1024) / 1024D - 0.5D) * d;
                double d2 = ((double)func_35016_a(1024) / 1024D - 0.5D) * d;
                func_35017_a(l2 + j + 1 << byte0, l1 + k << byte0);
                double d3 = ((double)func_35016_a(1024) / 1024D - 0.5D) * d + (double)i;
                double d4 = ((double)func_35016_a(1024) / 1024D - 0.5D) * d;
                func_35017_a(l2 + j << byte0, l1 + k + 1 << byte0);
                double d5 = ((double)func_35016_a(1024) / 1024D - 0.5D) * d;
                double d6 = ((double)func_35016_a(1024) / 1024D - 0.5D) * d + (double)i;
                func_35017_a(l2 + j + 1 << byte0, l1 + k + 1 << byte0);
                double d7 = ((double)func_35016_a(1024) / 1024D - 0.5D) * d + (double)i;
                double d8 = ((double)func_35016_a(1024) / 1024D - 0.5D) * d + (double)i;
        ...
        for(int j2 = 0; j2 < p_35018_4_; j2++)
        {
            System.arraycopy(ai1, (j2 + (p_35018_2_ & i - 1)) * (l << byte0) + (p_35018_1_ & i - 1), ai2, j2 * p_35018_3_, p_35018_3_);
        }
