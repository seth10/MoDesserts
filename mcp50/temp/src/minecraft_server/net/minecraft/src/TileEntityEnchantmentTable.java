...
public class TileEntityEnchantmentTable extends TileEntity
{
    ...
    public void func_184_b()
    {
        ...
        EntityPlayer entityplayer = field_479_a.func_456_a((float)field_478_b + 0.5F, (float)field_483_c + 0.5F, (float)field_482_d + 0.5F, 3D);
        if(entityplayer != null)
        {
            double d = entityplayer.field_322_l - (double)((float)field_478_b + 0.5F);
            double d1 = entityplayer.field_320_n - (double)((float)field_482_d + 0.5F);
