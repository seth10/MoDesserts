...
public class ModelIronGolem extends ModelBase
{
    ...
    public void setLivingAnimations(EntityLiving par1EntityLiving, float par2, float par3, float par4)
    {
        ...
        if (i > 0)
        {
            ironGolemRightArm.rotateAngleX = -2F + 1.5F * func_48228_a((float)i - par4, 10F);
            ironGolemLeftArm.rotateAngleX = -2F + 1.5F * func_48228_a((float)i - par4, 10F);
        }
        else
        {
            ...
            if (j > 0)
            {
                ironGolemRightArm.rotateAngleX = -0.8F + 0.025F * func_48228_a(j, 70F);
                ironGolemLeftArm.rotateAngleX = 0.0F;
            }
            else
            {
                ironGolemRightArm.rotateAngleX = (-0.2F + 1.5F * func_48228_a(par2, 13F)) * par3;
                ironGolemLeftArm.rotateAngleX = (-0.2F - 1.5F * func_48228_a(par2, 13F)) * par3;
            }
        }
    }
