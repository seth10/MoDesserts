...
final class ConsoleLogFormatter extends Formatter
{
    ...
    private SimpleDateFormat field_839_a;

    ConsoleLogFormatter()
    {
        field_839_a = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    }

    public String format(LogRecord p_format_1_)
    {
        StringBuilder stringbuilder = new StringBuilder();
        stringbuilder.append(field_839_a.format(Long.valueOf(p_format_1_.getMillis())));
